      ...
      notes: {
        ...
        children: {
          ...
          'gsaas.txt': {
            type: 'file',
            content:
              "generative software as a service is the new saas. it goes beyond being just an ai lab offering a model—it's about delivering software that creates value for the user and selling it as a subscription",
          },
        },
      },
      ascii: {
